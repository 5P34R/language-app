        ...
        <section className="text-gray-600 body-font relative h-screen">
            <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
                <div className="lg:block md:block sm:hidden mb">
                    ...
                    <div className="w-full font-medium flex-wrap text-2xl p-20">
                        User Login
                    </div>
                </div>
                <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0 p-5 px-10">
                    ...
                    <Button
                        onClick={handleLogin}
                        className="mt-10 text-white bg-yellow-400 border-0 py-2 px-6 focus:outline-none hover:bg-yellow-500 rounded-full text-lg font-medium"
                    >
                        Login
                    </Button>
                    ...
                    <Link href="/register"><Button variant={"link"} className="text-blue-500">Register here</Button></Link>
                    </div>
